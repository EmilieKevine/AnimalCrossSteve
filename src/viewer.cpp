...
void Viewer::run()
{
    ...
    {
        /*std::cout << "Orientation" << camera->Orientation[0] << std::endl; " " << camera->Orientation[1] << " " << camera->Orientation[2] << std::endl;
        ...
        //Update of the callback to make an animation
        ...
        glm::mat4 projection = glm::mat4(1.0f); //glm::perspective(glm::radians(45.0f), 1280.f/720.f, 0.1f, 10.0f);
