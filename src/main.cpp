...
int main()
{
    ...
    sf::Music music;
    if (!music.openFromFile(object_dir + "chill.mp3")) {
        std::cerr << "Error in loading music" << std::endl;
    }
    ...
    Shape* cube = new TexturedCube(skybox_shader, skybox, glm::vec3(0.0f, -30.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f), white);
     ...
     ****************************/
     ...
     // Create cube with skybox
    Shape* cube2 = new TexturedCube(skybox_shader, skybox2, glm::vec3(4.001f, -30.0f, 0.0f), glm::vec3(1.0f, 1.0f, 1.0f), white);
    ...
    if (model_node9 != nullptr) {
        // Appliquer une transformation initiale (taille et position)
        model_node9->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(1.0f, -1.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(95.0f), glm::vec3(1.0f, 1.0f, 1.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::scale(glm::mat4(1.0f), glm::vec3(0.2f))
        );

        viewer.scene_root->add(model_node9); // Ajout à la scène
    }
    ...
    if (model_node10 != nullptr) {
        // Appliquer une transformation initiale (taille et position)
        model_node10->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(1.0f, -1.2f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(95.0f), glm::vec3(1.0f, 1.0f, 1.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::scale(glm::mat4(1.0f), glm::vec3(0.2f))
        );

        viewer.scene_root->add(model_node10); // Ajout à la scène
    }
    ...
    if (model_node11 != nullptr) {
        // Appliquer une transformation initiale (taille et position)
        model_node11->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(5.501f, -1.9f, 1.5f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
        ...
        viewer.scene_root->add(model_node11); // Ajout à la scène
    }
    ...
    if (model_node12 != nullptr) {
        // Appliquer une transformation initiale (taille et position)
        model_node12->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(4.001f, -1.8f, 1.5f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f)) *
            glm::scale(glm::mat4(1.0f), glm::vec3(0.1f))
        ...
        viewer.scene_root->add(model_node12); // Ajout à la scène
    }
    ...
    * // node Objet  13
    ...
    if (model_node13 != nullptr) {
        // Appliquer une transformation initiale (taille et position)
        model_node13->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(5.8f, -1.8f, 1.f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f)) *
            glm::scale(glm::mat4(1.0f), glm::vec3(0.1f))
        ...
        viewer.scene_root->add(model_node13); // Ajout à la scène
    }
    */
    ...
    if (model_node13 != nullptr) {
        // Appliquer une transformation initiale (taille et position)
        model_node13->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(2.801f, -0.5f, 2.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f)) *
            glm::scale(glm::mat4(1.0f), glm::vec3(0.1f))
    ...
    *  // node Objet  14
    ...
    if (model_node14 != nullptr) {
        ...
        model_node14->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(8.0f, -1.8f, -1.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f))*
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f)) *
        ...
        viewer.scene_root->add(model_node14); // Ajout à la scène
    }
    ...
    */
    ...
    if (model_node18 != nullptr) {
        // Appliquer une transformation initiale (taille et position)
        model_node18->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(5.801f, -2.0f, -1.7f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f)) *
        ...
        viewer.scene_root->add(model_node18); // Ajout à la scène
    }
    ...
    if (model_node17 != nullptr) {
        // Appliquer une transformation initiale (taille et position)
        model_node17->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(4.201f, -2.0f, -0.8f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
        ...
        viewer.scene_root->add(model_node17); // Ajout à la scène
    }
    ...
    if (model_node15 != nullptr) {
        // Appliquer une transformation initiale (taille et position)
        model_node15->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(2.501f, -2.0f, 1.5f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 0.0f, 1.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::scale(glm::mat4(1.0f), glm::vec3(0.1f))
        ...
        viewer.scene_root->add(model_node15); // Ajout à la scène
    }
    ...
    auto updateFunc = [&]() {
        ...
        model_node4->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(-1.67f, -2.0f, 0.0f))*
            //glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(-1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(270.0f), glm::vec3(0.0f, -1.0f, 0.0f))*
        ...
        model_node9->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(-1.5f, -2.0f, -1.4f)) *
            //glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(-1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f)) *
        ...
        model_node10->setTransform(
            glm::translate(glm::mat4(1.0f), glm::vec3(4.501f, -2.0f, 1.6f)) *
            //glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(-1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(180.0f), glm::vec3(0.0f, 1.0f, 0.0f)) *
            glm::rotate(glm::mat4(1.0f), glm::radians(0.0f), glm::vec3(0.0f, 0.0f, 1.0f)) *
